...
uri = "mongodb+srv://outreachshaikatmajumder:atxgDMyZlTHXIamw@cluster0.jlqt27v.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
...
recipe_documents = [
    ...
    {"name": "fried rice", "ingredients": ["rice", "soy sauce", "egg", "onion", "pea", "carrot", "sesame oil"],
     "prep_time": 40},
    {"name": "patatas bravas02", "ingredients": ["potato", "tomato", "olive oil", "onion", "garlic", "paprika"],
     "prep_time": 80},
    {"name": "fried rice02", "ingredients": ["rice", "soy sauce", "egg", "onion", "pea", "carrot", "sesame oil"],
     "prep_time": 40}
]
